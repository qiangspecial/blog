	...
	render: function() {
		return (
			React.createElement("form", null, 
				React.createElement("input", {type: "text", placeholder: "Search...", value: this.props.filterText, onInput: this.onInput}), 
				React.createElement("p", null, 
					React.createElement("label", null, 
						React.createElement("input", {type: "checkbox", id: "isStockOnly", checked: this.props.isStockOnly}), 
						' ', 
	...
	render: function() {
		return (
			React.createElement("div", null, 
				React.createElement(SearchBar, {filterText: this.state.filterText, isStockOnly: this.state.isStockOnly}), 
